Shader "FlatKit_Old/Stylized Surface Fatness Silhouette" {
	Properties {
		...
		_WidthX ("Width X", Range(0.01, 5)) = 1
		_WidthY ("Width Y", Range(0.01, 5)) = 1
		_PoofMax ("Poof max", Range(-1, 3)) = 0
		_PoofMin ("Poof min", Range(-1, 3)) = 0
		_PoofYPos ("Poof Y pos", Float) = 0
