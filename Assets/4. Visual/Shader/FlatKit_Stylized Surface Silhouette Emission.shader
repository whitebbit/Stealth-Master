Shader "FlatKit_Old/Stylized Surface Silhouette Emission" {
	Properties {
		...
		[Space(10)] [NoScaleOffset] _EmissionTex ("[EMISSION_MAP_ON]Emission Texture", 2D) = "black" {}
		[Space(10)] _FlatSilhouetteColor ("Silhouette Color", Vector) = (1,1,1,1)
		...
		[Toggle(DR_MOD_COLOR_ON)] _ModColorEnabled ("Mod Color", Float) = 0
		_Saturation ("Saturation", Range(0, 1)) = 1
		_ModR ("Modify Red Channel", Range(-1, 1)) = 0
		_ModG ("Modify Green Channel", Range(-1, 1)) = 0
		_ModB ("Modify Blue Channel", Range(-1, 1)) = 0
	}
